...
let{name, price, soldCount=0, stockCoint=0} = goods;
console.log(name, price, soldCount, stockCoint);
...
// ex5 - 함수의 파라미터
const averageScore = function({score:{math:ma=0, korean:k=0 , science:s=0, music:mu=0}}) {
